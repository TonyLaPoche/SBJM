...
export function Header() {
  ...
  return (
    ...
    >
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-4 py-3.5 sm:px-6 sm:py-4 md:px-8">
        <Link
          href="/"
      ...
      >
        ...
        <div
          className={`absolute inset-y-0 right-0 flex w-full max-w-md flex-col border-l border-line bg-paper px-6 pb-8 pt-24 shadow-[-20px_0_60px_rgba(22,20,18,0.12)] transition-transform duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] sm:px-10 ${
